...
import '../../css/sidebarSindico.css'; // Importa o arquivo de folha de estilos CSS com as novas classes
...
const SidebarSindico = () => {
  ...
  return (
    ...
    <div className="sd-wrapper">
      ...
      <div className="sd-header" onClick={toogleMenuLarateral}>
        {/* Botão interativo que contém o ícone do menu (hambúrguer) */}
        <button className="sd-menu-btn">
      ...
      <nav className="sd-nav-area">
        ...
        <ul className="sd-nav-list">
          ...
          <li className="sd-nav-item sd-item-active">
            {/* Ícone SVG: Casa (Início) */}
            <svg viewBox="0 0 24 24" width="22" height="22" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" className="sd-icon">
              <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
              <polyline points="9 22 9 12 15 12 15 22"></polyline>
            </svg>
            {/* Texto descritivo do botão */}
            <span className="sd-label">Inicio</span> 
          </li>
          ...
          <li className="sd-nav-item">
            ...
            <span className="sd-label">Usúarios</span>
          </li>
          ...
          <li className="sd-nav-item">
            ...
            {/* Texto descritivo do botão */}
            <span className="sd-label">Reservas</span>
          </li>
          ...
          <li className="sd-nav-item">
            ...
            {/* Texto descritivo do botão */}
            <span className="sd-label">Comunicados</span> 
          </li>
          ...
          <li className="sd-nav-item">
            ...
            {/* Texto descritivo do botão */}
            <span className="sd-label">Condominio</span>
          </li>
