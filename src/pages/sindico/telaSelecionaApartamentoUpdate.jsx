...
import { ApertamentoCardSelecionadoUpdade } from "../../components/sindico/cardApertamentoSelecionadoUpdate"

//Função que cria o componente
function PaginaSelecionaApertamentoUpdate(){
    ...
    //Pegando os dados passados pelo state
    const idMorador = location.state?.idMorador
...
export default PaginaSelecionaApertamentoUpdate